...
```{r look at relationship across the cortex between beta and exponent}

library(ggplot2)
library(ggsegDesterieux)


atlas$corrAlpha= mapply(cor,exponent_BIC,corrbeta_BIC, use= 'complete.obs', method= 'spearman')
atlas$modelAlpha= mapply(cor,exponent_BIC,model_beta_clean, use= 'complete.obs', method= 'spearman')
atlas$corrdiff = atlas$corrAlpha - atlas$modelAlpha
